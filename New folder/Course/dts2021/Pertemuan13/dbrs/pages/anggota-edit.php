...
<div id="content">
	...
	<table id="tabel-input">
		...
		<tr>
			<td class="label-formulir">Spesialis</td>
			<td class="isian-formulir"><textarea rows="2" cols="40" name="spesialis" class="isian-formulir isian-formulir-border"><?php echo $r_tampil_anggota['spesialis']; ?></textarea></td>
		</tr>
		<tr>
			<td class="label-formulir"></td>
