...
<body>
    <div id="container">
        <div id="header">
                    ...
                    <div class="col">
                        ...
                        <FORM CLASS="form-inline" METHOD="POST">
                            <div align="right">
                                <form method=post>
                                    ...
                                    <input class="bg-primary" type="submit" name="search" value="search" class="tombol">
                                </form>
                        </FORM>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="tombol-opsi-container"><a href="pages/anggota-edit.php?id=<?php echo $r_tampil_anggota['idanggota'];?>" class="tombol">Edit</a></div>
            ...
            ?>
            <div style="float: left; margin-left: 18rem;">		
                <?php
                    $jml = mysqli_num_rows(mysqli_query($db, $queryJml));
                    echo "Jumlah Data : <b>$jml</b>";
                ?>			
                </div>		
                <div class="pagination mb-5 mb-5" style="margin-left: 73rem; margin-botton: 15rem">		
                        <?php
