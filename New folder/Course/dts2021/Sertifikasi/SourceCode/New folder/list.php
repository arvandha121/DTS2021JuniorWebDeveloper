            ...
            <nav class="navbar navbar-expand-xl navbar-dark bg-secondary shadow fixed-top">
                <div class="container">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active disabled" href="#">Calon Peserta</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <div class="mb-3">
                    <nav>
                        <a style="color: ; text-decoration: none; pointer-events: none;" href="daftar.php?tambah-daftar-baru">
                            <button disabled type="button" class="btn btn-primary">Tambah Baru</button>
                        </a>
                    </nav>
                </div>
                <div class="mb-3">
                        ...
                        <tbody>
                            <?php 
                                ...
                                while($siswa = mysqli_fetch_array($query)){
                                    ...
                                    echo "<a style='text-decoration: none; pointer-events: none;' href=' form-edit.php?id=" .$siswa['id']. " '><button disabled type='button' class='btn btn-warning ml-1'>Edit</button></?a>";?>
                                    <a style="pointer-events: none;" href="hapus.php?id=<?php echo $siswa['id']; ?>" onclick = "return confirm ('Apakah Anda Yakin Akan Menghapus Data Ini?')"><button disabled type="button" class="btn btn-danger">Hapus</button></a>
                                    <?php echo "</td>";
